...
const SUITES_FICHE_DATA = [
  ...
  },
  {
    ...
    rows: [
      ...
      {
        label: '$\\infty-\\infty$\npolynômes',
        tex: 'n^2-2n+5\\xrightarrow[n\\to+\\infty]{}+\\infty',
        vars: '**Méthode :** factoriser par le terme de plus haut degré — $n^2\\!\\left(1-\\tfrac{2}{n}+\\tfrac{5}{n^2}\\right)\\to n^2\\times 1=+\\infty$',
      },
      {
        label: '$\\infty-\\infty$\nracines',
        tex: '\\sqrt{n^2+n}-n\\xrightarrow[n\\to+\\infty]{}\\dfrac{1}{2}',
        vars: '**Méthode :** quantité conjuguée — $\\dfrac{(n^2+n)-n^2}{\\sqrt{n^2+n}+n}=\\dfrac{n}{\\sqrt{n^2+n}+n}\\to\\dfrac{1}{2}$',
      },
      {
        label: '$\\dfrac{\\infty}{\\infty}$',
        tex: '\\frac{3n+1}{n^2+2n-8}\\xrightarrow[n\\to+\\infty]{}0',
        vars: '**Méthode :** factoriser — $\\dfrac{n(3+1/n)}{n^2(1+2/n-8/n^2)}=\\dfrac{1}{n}\\cdot\\dfrac{3+1/n}{1+\\cdots}\\to 0$',
      },
      {
        label: '$0\\times\\infty$',
        tex: 'n^2\\cdot e^{-n}\\xrightarrow[n\\to+\\infty]{}0',
        vars: '**Méthode :** réécrire en fraction — $\\dfrac{n^2}{e^n}\\to 0$ (croissances comparées : $n^\\alpha\\ll e^n$)',
      },
    ],
  },
  {
