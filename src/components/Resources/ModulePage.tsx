...
const SUITES_FICHE_DATA = [
  ...
  },
  {
    ...
    rows: [
      {
        label: 'FI $\\infty-\\infty$\npolynômes',
        tex: '\\underbrace{n^2-2n+5}_{\\infty\\,-\\,\\infty} = n^2\\!\\underbrace{\\left(1-\\tfrac{2}{n}+\\tfrac{5}{n^2}\\right)}_{\\to\\,1} \\longrightarrow +\\infty',
        vars: '**Méthode — factoriser par le terme dominant** ($n^2$ ici) : les autres termes → 0, il reste $n^2\\to+\\infty$.',
      },
      {
        label: 'FI $\\infty-\\infty$\nracines',
        tex: '\\underbrace{\\sqrt{n^2+n}-n}_{\\infty\\,-\\,\\infty} = \\frac{n}{\\sqrt{n^2+n}+n} = \\frac{1}{\\sqrt{1+1/n}+1} \\longrightarrow \\dfrac{1}{2}',
        vars: '**Méthode — quantité conjuguée** : multiplier par $\\dfrac{\\sqrt{n^2+n}+n}{\\sqrt{n^2+n}+n}$ pour faire apparaître $A-B=(\\sqrt{A}-\\sqrt{B})(\\sqrt{A}+\\sqrt{B})$.',
      },
      {
        label: 'FI $\\dfrac{\\infty}{\\infty}$',
        tex: '\\underbrace{\\dfrac{3n+1}{n^2+2n-8}}_{\\infty/\\infty} = \\dfrac{1}{n}\\cdot\\dfrac{3+\\frac{1}{n}}{1+\\frac{2}{n}-\\frac{8}{n^2}} \\longrightarrow 0',
        vars: '**Méthode — factoriser** par $n$ au numérateur et $n^2$ au dénominateur, puis simplifier : seul le rapport des termes dominants compte.',
      },
      {
        label: 'FI $0\\times\\infty$',
        tex: '\\underbrace{n^2\\cdot e^{-n}}_{0\\,\\times\\,\\infty} = \\dfrac{n^2}{e^n} \\longrightarrow 0',
        vars: '**Méthode — réécrire en fraction** $\\dfrac{0}{0}$ ou $\\dfrac{\\infty}{\\infty}$, puis exploiter les **croissances comparées** : $n^\\alpha\\ll e^n$.',
      },
    ],
  },
  {
